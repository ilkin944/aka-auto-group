    ...
    >
      ...
      <div className="z-50 flex flex-col justify-center text-white w-full h-screen">
        <h1 className="text-5xl">
          We are <b>Under Construction</b>!
        </h1>
        <p>Stay tuned for updates and the latest news</p>
        ...
        <div className="w-full flex items-center justify-center gap-3">
          <Link href={'mailto:info@akaautogroup.ca'} className="mt-5 px-4 py-2 bg-indigo-600 text-white rounded-full">
            info@akaautogroup.ca
          </Link>
        </div>
      </div>
    </div>
